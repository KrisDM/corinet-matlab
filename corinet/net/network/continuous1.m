function [netExecStruct,blockExecStructs,context] = ...
    continuous1(netExecStruct,blockExecStructs,context,blockIDs)

%CONTINUOUS1 Network execute function for use in BlockNodePool networks
% Weights are adjusted during integration
...
numBlockExecs = numel(blockExecStructs);
...
for i=1:numIterations
    ...
    for t=1:context.numSteps
        for e=1:numBlockExecs
