function pcbcbActivationPlot2(command,S,nodeValues,varargin)

%PCBCACTIVATIONPLOT2 Plot the activation for the pcbcb2 function
...
switch command
    case 'PCBC1',
        ...
        set(gca,'XLim',limY); 
        hold on;
        plot((S.W*S.E).*varargin{1},styleY2);
        title('W*E,(W*E)*FB');
        %%%%%%%%%%%%%%%
        subplot(3,3,6);
        plot(S.Y,styleY1);
